...
This tutorial will help you install custom palettes for the **GamBatte** emulator. You can download here:
...
1. Create or find the `/mnt/.gambatte/palettes` directory
5. Drag and drop all the .pal files into this path.

**Directory**

`/mnt/.gambatte/palettes/<.pal files>`
