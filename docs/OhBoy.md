...
This tutorial will help you install custom palettes for the **OhBoy** emulator. You can download [here](assets/2TMAU5_Custom_Palettes_for_Ohboy.zip)
...
1. Create or find the /mnt/.ohboy/palettes directory.
2. Drag and drop all the .pal files into this path.

**Directory**

`/mnt/.ohboy/palettes/<.pal files>`
